...
# Lastmod date unless I forgot to change it: 2021-11-12
# 
##########################################################################################
...
cvFile = {
    ...
    'NCBI' : '%s/ncbi_taxonomy.tsv' % cvRefDir,
...
targetTSVs = ( 'file.tsv', 'biosample.tsv', 'biosample_disease.tsv', 'biosample_gene.tsv', 'subject_disease.tsv', 'subject_role_taxonomy.tsv' )
            ...
            for termID in sorted( termsUsed[categoryID] ):
                ...
                if 'name' in termsUsed[categoryID][termID]:
                    ...
                    if 'synonyms' in termsUsed[categoryID][termID]:
                        ...
                        # Synonyms for the two categories excluded here are preprocessed by us in advance and shouldn't need help.

                        if categoryID != 'ncbi_taxonomy' and categoryID != 'gene':
