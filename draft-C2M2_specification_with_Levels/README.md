...
##### Core entities
   ...
   * **`file` _revisited** (superset additions: cf. below, §"Common entity fields" and §"Controlled
   vocabularies and term tables")_
   * **`biosample` _introduced** (also cf. below, §"Common entity fields" and §"Controlled vocabularies and
   term tables")_
   ...
   * **`subject` _introduced** (also cf. below, §"Common entity fields" and §"Taxonomy and the `subject` entity")_
