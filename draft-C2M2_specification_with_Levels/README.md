...
| `abbreviation`, `name` and `description` | _Values for contextual display in portal and dashboard interfaces: severely restricted (_`/[a-zA-Z0-9_]*/`_)_ `abbreviation` _; terse but flexible_ `name` _; abstract-length_ `description` |
