...
![Level 0 model diagram](../C2M2_ER_diagrams/Level-0-C2M2-model.png)
...
[here](../C2M2_JSON_Schema_datapackage_specs_index), and
an example Level-0-compliant TSV submission can be found [here](./example_submission_data_index.html#level-0), as just the `file.tsv` portion or as a full BDBag archive.
