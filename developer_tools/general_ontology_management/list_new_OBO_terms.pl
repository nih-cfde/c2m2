...
print "OLD SET SIZE: $oldSetCount terms\nNEW SET SIZE: $newSetCount terms\nTERMS IN BOTH SETS: $bothTermCount terms\n$newTermCount NEW TERMS:\n";

foreach my $id ( sort { $a cmp $b } keys %$newTerms ) {
